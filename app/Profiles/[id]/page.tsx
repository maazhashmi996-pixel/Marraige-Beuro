...
export default function SingleProfilePage() {
    ...
    useEffect(() => {
        const fetchFullProfile = async () => {
            ...
            // Agar token nahi hai to seedha custom error set karein
            if (!token) {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    // Backend se aane wale errors (Limit exceed, Not approved etc)
    ...
    return (
        <div className="min-h-screen bg-[#fcfafa] py-12 px-4">
            <div className="max-w-4xl mx-auto">
                ...
                {error ? (
                    /* ================= UPDATED ERROR/RESTRICTED STATE ================= */
                    <motion.div
                        ...
                        <div className="p-8 md:p-14 space-y-14">
                            ...
                            <div className="p-10 bg-gradient-to-br from-yellow-50 to-white rounded-[3rem] border-2 border-dashed border-[#c19206]/30 shadow-xl shadow-yellow-600/5">
                                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                                    ...
                                    <button
                                        onClick={() => window.open(`https://wa.me/923123456789`, '_blank')}
